...
w_tp(uint64 x)
{
  ...
  3a:	7ff70713          	add	a4,a4,2047 # ffffffffffffe7ff <ustack+0xfffffffffffed71f>
  3e:	8ff9                	and	a5,a5,a4
  x |= MSTATUS_MPP_S;
  40:	6705                	lui	a4,0x1
  42:	80070713          	add	a4,a4,-2048 # 800 <process_entry+0x3e4>
  46:	8fd9                	or	a5,a5,a4
  ...
  56:	3b878793          	add	a5,a5,952 # 40a <kernel_entry>
  5a:	34179073          	csrw	mepc,a5
  asm volatile("csrw medeleg, %0" : : "r" (x));
  5e:	67c1                	lui	a5,0x10
  60:	17fd                	add	a5,a5,-1 # ffff <kstack+0x6f1f>
...
ramdiskrw(struct buf *b)
{
  ...
  98:	44dc                	lw	a5,12(s1)
  9a:	00a7979b          	sllw	a5,a5,0xa
  9e:	1782                	sll	a5,a5,0x20
  a0:	9381                	srl	a5,a5,0x20
  ...
  aa:	05ea                	sll	a1,a1,0x1a
  ac:	95be                	add	a1,a1,a5
  ae:	02848513          	add	a0,s1,40
  ...
  c0:	6442                	ld	s0,16(sp)
  c2:	64a2                	ld	s1,8(sp)
  c4:	6105                	add	sp,sp,32
  c6:	8082                	ret
    panic("ramdiskrw: blockno too big");
  c8:	00000517          	auipc	a0,0x0
  cc:	36850513          	add	a0,a0,872 # 430 <process_entry+0x14>
...
memcmp(const void *v1, const void *v2, uint n)
{
 ...
 104:	fff6069b          	addw	a3,a2,-1
 108:	1682                	sll	a3,a3,0x20
 10a:	9281                	srl	a3,a3,0x20
 10c:	0685                	add	a3,a3,1
 ...
 146:	00c587b3          	add	a5,a1,a2
{
 ...
 160:	8082                	ret
  if(s < d && s + n > d){
 162:	02061693          	sll	a3,a2,0x20
 166:	9281                	srl	a3,a3,0x20
 168:	00d58733          	add	a4,a1,a3
 16c:	fce57be3          	bgeu	a0,a4,142 <memmove+0xc>
    d += n;
 170:	96aa                	add	a3,a3,a0
    while(n-- > 0)
 172:	fff6079b          	addw	a5,a2,-1
 176:	1782                	sll	a5,a5,0x20
 178:	9381                	srl	a5,a5,0x20
 17a:	fff7c793          	not	a5,a5
 17e:	97ba                	add	a5,a5,a4
      *--d = *--s;
 180:	177d                	add	a4,a4,-1
 182:	16fd                	add	a3,a3,-1
...
safestrcpy(char *s, const char *t, int n)
{
 ...
 22c:	fff6069b          	addw	a3,a2,-1
 230:	1682                	sll	a3,a3,0x20
 232:	9281                	srl	a3,a3,0x20
...
void* kalloc(void) {
 ...
 2fc:	d0878793          	add	a5,a5,-760 # 1000 <alloc_pages>
 300:	4388                	lw	a0,0(a5)
    alloc_pages++;
 302:	0015071b          	addw	a4,a0,1
 306:	c398                	sw	a4,0(a5)
    uint64 addr = ((uint64)KMEMSTART+(alloc_pages*PGSIZE));
 308:	00c5151b          	sllw	a0,a0,0xc
    return (void*) addr;
}
 30c:	4785                	li	a5,1
 30e:	07fe                	sll	a5,a5,0x1f
...
void* kalloc(void) {
 ...
 320:	13450513          	add	a0,a0,308 # 450 <process_entry+0x34>
 324:	00000097          	auipc	ra,0x0
 328:	f5a080e7          	jalr	-166(ra) # 27e <panic>
    uint64 addr = ((uint64)KMEMSTART+(alloc_pages*PGSIZE));
 32c:	00001797          	auipc	a5,0x1
 330:	cd478793          	add	a5,a5,-812 # 1000 <alloc_pages>
 334:	4388                	lw	a0,0(a5)
    alloc_pages++;
 336:	0015071b          	addw	a4,a0,1
 33a:	c398                	sw	a4,0(a5)
    uint64 addr = ((uint64)KMEMSTART+(alloc_pages*PGSIZE));
 33c:	00c5151b          	sllw	a0,a0,0xc
}
 340:	4785                	li	a5,1
 342:	07fe                	sll	a5,a5,0x1f
...
void usertrapret(void) {
 ...
 358:	cbc70713          	add	a4,a4,-836 # 9010 <p>
 35c:	633c                	ld	a5,64(a4)
 35e:	0000a697          	auipc	a3,0xa
 362:	d8268693          	add	a3,a3,-638 # a0e0 <kstack+0x1000>
 366:	e794                	sd	a3,8(a5)
 ...
 36e:	03868693          	add	a3,a3,56 # 3a2 <usertrap>
 ...
 384:	eff7f793          	and	a5,a5,-257
    x |= SSTATUS_SPIE; // enable interrupts in user mode
 388:	0207e793          	or	a5,a5,32
...
void create_process(void) {
 ...
 3f4:	cf070713          	add	a4,a4,-784 # 120e0 <ustack+0x1000>
